...
local package_id = "com."..package_prefix..".mob."..package_gid.."-"..package_name.."V3"
...
function package_init(package)
    ...
    package:set_name(package_name.." V3".." (EXEPoN)")
    package:set_description("Test fight with "..package_name.." V3 from EXEPoN")
    package:set_speed(1)
...
function package_build(mob)
    ...
    local spawner = mob:create_spawner(character_id..package_name,Rank.V3)
