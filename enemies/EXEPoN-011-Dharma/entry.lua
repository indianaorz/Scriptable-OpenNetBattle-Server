...
local package_gid = "EXEPoN-011"
local package_name = "Dharma"
local package_name2 = "Dharga"
local package_name3 = "Dhardara"
...
function package_build(mob) 
    ...
    local test_spawner1 = mob:create_spawner(character_id..package_name2,Rank.V1)
    test_spawner1:spawn_at(4, 1)
    local test_spawner2 = mob:create_spawner(character_id..package_name3,Rank.V1)
    test_spawner2:spawn_at(5, 2)
    local test_spawner3 = mob:create_spawner(character_id..package_name,Rank.SP)
