...
local package_gid = "EXEPoN-026"
local package_name = "GutsMan"

local package_id = "com."..package_prefix..".mob."..package_gid.."-"..package_name.."V4"
...
function package_init(package)
    ...
    package:set_name(package_name.." SP".." (EXEPoN)")
    package:set_description("Test fight with "..package_name.." SP from EXEPoN")
    package:set_speed(1)
...
function package_build(mob)
    --local texPath = _modpath.."MeiruHP.png"
    --local animPath = _modpath.."MeiruHP.animation"
    --local texPath = _modpath.."exe4-akiharaarea.png"
    --local animPath = _modpath.."exe4-akiharaarea.animation"
    ...
    local spawner = mob:create_spawner(character_id..package_name,Rank.SP)
