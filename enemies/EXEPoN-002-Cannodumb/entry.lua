...
local package_gid = "EXEPoN-002"
local package_name = "Cannodumb"
...
function package_build(mob) 
    ...
    local test_spawner2 = mob:create_spawner(character_id..package_name,Rank.V2)
    test_spawner2:spawn_at(5, 2)
    local test_spawner3 = mob:create_spawner(character_id..package_name,Rank.V3)
